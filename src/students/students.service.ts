...
export class StudentService {
  ...
  async getSingleStudent(StudentId: number,path: string,method: string,date: string): Promise<CommonResponse> {
  ...
  async insertStudent (student : StudentDTO, path: string,method: string,date: string ): Promise<CommonResponse>  {
  ...
  async getStudents (reqbody : GetStudentsDTO, path: string,method: string,date: string ): Promise<CommonResponse>  {
    var students = []
    try{
